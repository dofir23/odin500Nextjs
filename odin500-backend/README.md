# Odin 500 Backend API

A robust Node.js/Express backend API for the Odin 500 trading application with real-time market data, ticker management, and watchlist functionality.
