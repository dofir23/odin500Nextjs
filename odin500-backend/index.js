...
const paperPublicRoutes = require('./routes/paperPublic');
...
const newsletterSubscriptionRoutes = require('./routes/newsletterSubscriptionRoutes');
...
app.use('/api/public/paper', paperPublicRoutes);
app.use('/api/admin', adminRoutes);
app.use('/api/reports', tickerReportRoutes);
app.use('/api/splits', splitsRoutes);
app.use('/api/notifications', notificationRoutes);
app.use('/api/newsletter', newsletterSubscriptionRoutes);
